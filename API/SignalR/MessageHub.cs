    ...
    public class MessageHub : Hub
    {
        ...
        private async Task<Group> AddToGroup(string groupName)
        {
            ...
            if(group == null )
            {
                ...
                _uow.MessageRepository.AddGruop(group);
            }
            ...
            throw new HubException("Failed to addd to group");
        }

        private async Task<Group> RemoveFromMessageGroup()
        {
            var group = await _uow.MessageRepository.GetGroupConnection(Context.ConnectionId);
